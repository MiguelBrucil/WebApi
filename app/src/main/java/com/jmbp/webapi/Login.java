...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ConsultarRegistroTask().execute("http://10.10.24.39/DATOS/cn.php");
    }
    private class ConsultarRegistroTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            ...
            if ("1".equals(resultado)) {
                Toast.makeText(Login.this, "usu correcto", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(Login.this, "usu incorrecto", Toast.LENGTH_SHORT).show();
            }
        }
